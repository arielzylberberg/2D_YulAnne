...
%         {'ig_p_ens'; 100; [80, 80, 20, 20]}; % [100, 0, 100, 0]}; % 
%         {'ig_en'; 200}; 
%         {'ig_st_en_mod', [0, 500, 0]};
...
%% Internal
properties
    EP = IxnKernel.RevCor.D1.Ev2PchD1; % For plotting
    
    Util = IxnKernel.EvTime.EvTimeD1; % Util.ev = is_t_util
end
properties (Dependent)
