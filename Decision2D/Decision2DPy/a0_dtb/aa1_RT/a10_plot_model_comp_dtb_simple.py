...
locfile_in = localfile.LocalFile(
    pth_root='../../Data_2D/Data_2D_Py/a0_dtb/RT_dtb_simple/orig_mat',
    cache_dir=''
)

locfile_out = localfile.LocalFile(
    pth_root='../../Data_2D/Data_2D_Py/a0_dtb/RT_dtb_simple',
    cache_dir=''
)
...
def load_comp(file: str) -> Dict[str, list]:
    ...
    for parad, key, new_parad in [
        ('RT', 'yuls_exp', 'S_RT'),
        ('unimanual', 'annes_mono', 'S_unimanual'),
        ('bimanual', 'annes_bi', 'S_bimanual'),
    ]:
